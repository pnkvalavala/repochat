...
OPENAI_HELP="""
To compute the embeddings, we need OpenAI API. If you come across any reliable open-source models for computing embeddings, please feel free to share them with us.\n
